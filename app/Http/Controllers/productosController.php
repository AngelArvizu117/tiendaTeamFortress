...
class productosController extends Controller
{
    public function mCategorias(){
     ...
     public function mProductosPorCategoria($id){
       ...
       ->select('p.id_p','p.nombre','p.descripcion','p.precio','p.evaluacion','p.cantidad','p.imagen')
       ->where('c.id_c','=',$id)
       ->get();
